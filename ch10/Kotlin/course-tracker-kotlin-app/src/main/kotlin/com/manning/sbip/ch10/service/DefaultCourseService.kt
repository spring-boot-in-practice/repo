...
@Service
class DefaultCourseService (private val courseRepository: CourseRepository) : CourseService {

    override fun createCourse(course: Course): Course =  courseRepository.save(course)

    override fun findCourseById(courseId: Long): Course = courseRepository.findById(courseId)
            .orElseThrow { CourseNotFoundException(HttpStatus.NOT_FOUND, "No course with supplied course id was found") }

    override fun findAllCourses(): Iterable<Course> =  courseRepository.findAll()
